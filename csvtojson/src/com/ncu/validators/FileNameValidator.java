...
public class NameValidator{
	...
	//configMessages will store path of file//
	//getProperty pic proprty file from user.dir//
	//user.dir means your current working directory & this value come from class path while running with -cp"path till classes"//
	// "configs/constants/exceptions.properties" this is same path for all there fore this path is hard coded//
	Properties prop = new Properties();
	InputStream input = null;
	//InputStream is class in java.io now its object is input//
	int fileLength;
	String RegexValue;
	...
	public boolean nameValidator(String fileName, String flag)	{   
		...
		//PropertyConfigurator inbuilt fuction to read property//
